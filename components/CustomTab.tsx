  ...
  return (
    <View style={styles.container}>
      <View style={styles.itemsContainer}>
        <TouchableOpacity
          style={
            getSelectedOption === 1 ? styles.activeButton : styles.defaultButton
          }
          onPress={() => updateSwitchData(1)}
        >
          <Text style={styles.defaultText}>{optionNameActive}</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={
            getSelectedOption === 2 ? styles.activeButton : styles.defaultButton
          }
          onPress={() => updateSwitchData(2)}
        >
          <Text style={styles.defaultText}>{optionNameFood}</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
