  ...
  return (
    <Layout>
      ...
      <View style={styles.textContainer}>
        <Text style={styles.personTitle}>Джо Байден, 80 рокiв</Text>
      </View>
      ...
      <View
        style={
          expand ? styles.descContainerExpand : styles.descContainerColapse
        }
      >
        <Text style={styles.descText}>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Nesciunt
          cupiditate voluptatum ducimus quis beatae numquam sit nihil quaerat
          odio optio, voluptatibus illo aperiam mollitia eaque vero vitae
          deserunt autem! Magni. Lorem ipsum dolor sit amet, consectetur
          adipisicing elit. Nisi natus deleniti et repellat non adipisci atque.
          Quisquam rem accusantium, aliquam quos unde excepturi? Quis nisi vero,
          deleniti assumenda adipisci voluptates.
        </Text>
      </View>
      ...
      <View>
        {selectedOption === 1 ? (
          <NeedyCard
            title={"Лікування від альцгеймеру"}
          ...
          <View>
            <Text style={styles.foodBasketText}>
              Також Ви можете допомогти, придбавши набір продуктів для місячного
              раціону нужденного.
            </Text>
            <FoodBasket
              foodRest={
              ...
              foodDesc={
                "5 упаковок рису, 2кг курячої грудки, пачка цигарок, пляшка пива, набір юного хіміка, жувальна гумка Orbit (без цукру)"
              }
            />
          </View>
        )}
